// Journey stops from Perth to Port Lincoln - Running to God
// This data will eventually come from Sanity CMS
...
export const journeyStops: JourneyStop[] = [
  {
    ...
    fullDescription: `Perth — the most isolated capital city in the world. Standing on the edge of a continent, looking east across thousands of kilometers of wilderness. This is where my journey began.
...
Leaving Perth meant leaving comfort, routine, and everything familiar. The city lights faded in my rearview mirror as the road stretched endlessly toward the rising sun. Sometimes the hardest part of any journey is simply choosing to begin.`,
    ...
    imageAlt: 'Perth city skyline at dawn with the open road stretching east'
  },
  {
    id: 'norseman-gateway',
    title: 'The Gateway',
...
This small mining town sits at the crossroads of decision. Turn back to civilization, or press forward into the wilderness. Something was calling me forward.`,
    ...
    imageAlt: 'The Norseman welcome sign with vast desert stretching behind'
  },
  {
    id: 'nullarbor-desert',
    ...
    fullDescription: `"Nullarbor" means "no trees" in Latin, and the name doesn't lie. For hundreds of kilometers, there's nothing but flat, red earth meeting an impossibly big sky. The road stretches in a perfect straight line to the horizon.
...
In this emptiness, something strange happens. The noise in your head slowly fades. The constant chatter of modern life, the worries, the to-do lists — they all seem so small out here. In the silence of the Nullarbor, you can finally hear yourself think. And if you're willing to listen, you can hear something more.`,
    ...
    imageAlt: 'The endless Nullarbor Plain stretching to the horizon'
  },
  {
    ...
    fullDescription: `Suddenly, the flat desert ends in sheer cliffs dropping hundreds of meters straight into the churning Southern Ocean. The Great Australian Bight is one of the most dramatic coastlines on Earth.

I stood at the lookout point, watching waves crash against the base of the cliffs. The ocean stretched to Antarctica. In that moment, I felt both incredibly small and strangely significant. If God made all of this, surely He knows me too.`,
    spiritualLesson: 'The vastness of creation reminds us of our Creator\'s power and majesty. Yet the same God who crafted the oceans knows every hair on our head. We are small, but we are loved.',
    bibleVerse: {
    ...
    imageAlt: 'The dramatic cliffs of the Great Australian Bight'
  },
  {
...
I met people from all over the world at these roadhouses. We'd share stories over coffee, strangers connected by the shared experience of crossing this vast land.`,
    ...
    imageAlt: 'A roadhouse in the middle of the Nullarbor at sunset'
  },
  {
...
I lay on my swag, wrapped in the cool desert air, staring up at a billion stars. The universe felt both impossibly vast and strangely intimate. My problems seemed to shrink against the backdrop of eternity.`,
    ...
    imageAlt: 'The Milky Way stretching across the night sky over the outback'
  },
  {
    id: 'ceduna-coast',
...
I sat at a cafe by the marina, watching fishing boats bob in the harbor. I realized I felt different. The restlessness that had driven me to start this journey had quieted. Something had shifted in the silence of the desert.`,
    ...
    imageAlt: 'Ceduna marina at sunset'
  },
  {
    ...
    fullDescription: `Port Lincoln sits at the southern tip of Eyre Peninsula, a beautiful fishing town known for its tuna and its stunning Boston Bay. After 2,400 kilometers, I had arrived.

But standing at the water's edge, I realized something important: the destination was never really the point. The journey itself had been the destination. Every kilometer, every roadhouse conversation, every star-filled night — they had all transformed me along the way.
...
I understood now why I had felt called to make this trip. I had been running — running from pain, from confusion, from questions I didn't want to face. But somewhere in the desert, I had stopped running away and started running toward. Toward healing. Toward truth. Toward God.`,
    ...
    imageAlt: 'Port Lincoln harbor at dawn'
  }
]
